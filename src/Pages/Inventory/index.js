...
const url ='http://10.0.2.216:5000/api/'
        ...
        <div className= " flex mb-4 m-6">
          <form className="flex flex-col gap-6 w-100">
            ...
            <div className="md:flex md:items-center mb-6">
              ...
              <div class="md:w-2/3">
                <input 
                  class="bg-gray-200 shadow appearance-none border-2 border-gray-200 rounded w-full py-2 px-4  text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 placeholder-gray-300" 
                  id="inline-password" 
                  type="password" 
